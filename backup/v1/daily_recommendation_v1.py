...
class DailyRecommendation:
    ...
    def run(self):
        ...
        for stock in final_results:
            ...
            if breakout_priority < 70:
                ...
                stock["rejected_by"].append(
                    "Breakout Priority < 70"
                )

                stock["decision_reasons"].append(
                    "Breakout Filter : Priority < 70"
                )
                ...
                stock["decision_reasons"].append(
                    "Breakout Filter : RSI > 80"
                )

        # =================================================
        # BUY ON WEAKNESS PRIORITY SCORE
        # =================================================
        ...
        for stock in final_results:
            ...
            # Technical Ranking
            score += stock["ranking_score"] * 0.20
